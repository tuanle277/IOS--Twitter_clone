...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "RF9VqtOzZKOGeW0dOnpyRkzQo", consumerSecret: "Yiir1Ghc8SDF93IoFSSB60lOabFLsqFPMysJ5w3ceaOn7ae0bK")
    var loginSuccess: (() -> ())?
